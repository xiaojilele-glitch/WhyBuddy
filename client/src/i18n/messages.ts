...
export const messages = {
  "zh-CN": {
    ...
    sidebar: {
      ...
      statusDone: "已完成",
      statusStandby: "待命中",
      missionControlFrontend: "前端模式",
      missionControlAdvanced: "高级模式",
    },
    launchPanel: {
      title: "任务自动驾驶",
  ...
  "en-US": {
    ...
    sidebar: {
      ...
      missionControlFrontend: "Frontend Mode",
      missionControlAdvanced: "Advanced Mode",
    },
    launchPanel: {
      title: "Task Autopilot Control",
      subtitle: "Autopilot Control",
      goalInputLabel: "Enter your goal",
      goalInputPlaceholder: "Describe the task goal you want to accomplish...",
      routePlanningTitle: "Autonomous Route Planning",
      cockpitTitle: "Capability Cockpit",
      outputTitle: "Output & Delivery",
